...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/server-udp/unicast-server.c</source>
      <commands EXPORT="discard">make unicast-server.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/server-udp/unicast-server.z1</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>38.06681831466532</x>
        <y>85.85468372136813</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>30.275952108645228</x>
        <y>77.14775573417133</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>11.902049178513836 0.0 0.0 11.902049178513836 -217.7095072870615 -817.5315253087774</viewport>
    </plugin_config>
    <width>400</width>
    <z>5</z>
    <height>400</height>
