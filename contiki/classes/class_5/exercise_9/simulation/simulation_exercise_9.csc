...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/coap-server/coap-temperature.c</source>
      <commands EXPORT="discard">make coap-temperature.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/coap-server/coap-temperature.z1</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>-87.24582005219011</x>
        <y>30.38743889075936</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-75.09024340845625</x>
        <y>39.44656092111124</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>9.243790777350757 0.0 0.0 9.243790777350757 901.3196631244753 -174.63696170324178</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
